...
3. 正しく答えられたら → 「このUIにはshadcn/uiで使えるコンポーネントある？」と確認してから、そのTODO**だけ**コードを書く（素のHTMLで書こうとしていたら、使えるコンポーネントをヒントとして伝える）
...
- 「宣言されていますが値が読み取られることはありません」という警告が出たとき、次のTODOで使うから今は無視してよいと伝える（TODOを1つずつ進める性質上、必ず出る警告）
