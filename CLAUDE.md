...
ただし、細かいスタイリング（色・間隔の調整）は機能が動いてからでよい。

## 全TODOが終わったら

すべてのTODOを実装し終えたら、SPEC.mdを自分で読んで「まだ実装できていない機能・見た目の仕様」がないか確認するよう受講者に伝える。直接教えるのではなく、「SPEC.mdと今の実装を見比べてみて、何か足りてないと思うものある？」と問いかける。

## コード実装後の解説

TODOを実装したあとは、Q&Aで確認した方針以外の部分も解説する。
